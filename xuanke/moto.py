...
class web_get():
    ...
    while(1):
        ...
        # content2 = web.find_element_by_xpath('//table[contains(@class,"zero-grid") and contains(@class,"zero-grid-hover")]/tbody/tr[2]/td/span').text
        ...
        for i in content:
            ...
            if int(a[0])!=int(a[1]): #有课
                ...
                # 填写你要发送的验证码  和  手机号码
                yunpian.send_sms('123456', '18328020353')
