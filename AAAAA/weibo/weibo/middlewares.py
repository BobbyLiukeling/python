...
class WeiboDownloaderMiddleware(object):
    ...
    def process_response(self, request, response, spider):
        self.web.get(request.url)#加载request.url网页
        time.sleep(2)
        self.web.find_element_by_xpath(".//ul[contains(@class,'nav-item') and contains(@class,'center')]/li[11]").click()
        time.sleep(2)
        body = self.web.page_source
        pdb.set_trace()
        Selector(text=self.web.page_source).xpath
